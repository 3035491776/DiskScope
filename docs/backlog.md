...
- `BATCH_CLEANUP`：M6.3 未开放。
- `DIRECTORY_CLEANUP`：M6.3 未开放。
- `APPLICATION_CACHE_CLEANUP`：M6.3 未开放。
- `SYSTEM_DUMP_CLEANUP`：M6.3 未开放。
- `RECYCLE_BIN_MANAGEMENT`：M6.3 未开放。
- `UNDO`：M6.3 未开放；DiskScope 不承诺或提供回收站恢复 API。
