...
1. 将完整发布包解压到当前用户可写目录，例如“下载”或“文档”。
2. 双击 `DiskScope.exe`。
3. 保持启动窗口打开。浏览器会自动打开 `http://127.0.0.1:8765/`。
4. 第一次使用可选择 Windows C: 或当前用户临时文件开始只读分析。
...
此 V0.1 构建未进行代码签名。Windows SmartScreen 或安全软件可能显示未知发布者/声誉提示；请通过项目发布页核对 ZIP 的 SHA-256，不要关闭或绕过系统安全功能。
